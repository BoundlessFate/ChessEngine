...
void StudentTests() {
  ...
  assert (student->next->prev->isEngine());
  assert (student->next->next->isPassengerCar());
  assert (student->next->next->next->isDiningCar());
  assert (student->next->next->next->next->isPassengerCar());
  assert (student->next->next->next->next->next->isSleepingCar());
  assert (student->next->next->next->next->next->next == NULL);
  assert (student->next->getID() == student->getID()+1);
  assert (student->next->next->getID() == student->next->getID()+1);
  ...
  assert (student->prev == NULL);
  assert (student->next->isPassengerCar());
  assert (student->next->next->isDiningCar());
  assert (student->next->next->next->isPassengerCar());
  assert (student->next->next->next->next->isSleepingCar());
  assert (student->next->next->next->next->next == NULL);
  assert (student->getID() == firstCar->getID()+1);
  assert (student->next->getID() == student->getID()+1);
  assert (student->next->next->getID() == student->next->getID()+1);
  assert (student->next->next->next->getID() == student->next->next->getID()+1);
  assert (student->next->next->next->next->getID() == student->next->next->next->getID()+1);
  ...
  std::cout << "Removed Car" << std::endl;
  assert (firstCar->prev == NULL);
